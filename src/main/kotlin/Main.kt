...
fun imprimeDadosLancamento(descricaoDoMovimento:String,distanciaRede:Double,acertouNaRede:Boolean,planeta: String,g:Double,altura:Double,v0:Double,angulo:Double,v0y:Double,v0x:Double,tempoVoo:Double,tempoSubida:Double,alcance:Double,alturaMaxima:Double) {
    if (!acertouNaRede) {
        println()
        println(
            """
            ...
            if (opcao == 1) {
                do {
                    ...
                    //Se o projetil se move em X é desenhado o grafico
                        ...
                        if (acertouNaRede) {
                            imprimeDadosLancamento("",distanciaRede,true,planeta,g,altura,v0,angulo,v0y,v0x,tempoVoo,tempoSubida,alcance,alturaMaxima)
                        }
                        //Se nao acertou na rede imprime os dados considerando que o movimento termina quando chega ao solo
                            ...
                            imprimeDadosLancamento(descricaoDoMovimento,distanciaRede,false,planeta,g,altura,v0,angulo,v0y,v0x,tempoVoo,tempoSubida,alcance,alturaMaxima)
                        }
                    }
